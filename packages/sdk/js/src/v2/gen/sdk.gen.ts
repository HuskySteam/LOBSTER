...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new LobsterClient()" to fix this error.`)
    }
    return instance
  }
...
export class LobsterClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<LobsterClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    LobsterClient.__registry.set(this, args?.key)
  }
