...
import { DialogPatterns } from "@tui/component/dialog-patterns"
...
function App() {
  ...
  createEffect(() => {
    if (!terminalTitleEnabled() || Flag.LOBSTER_DISABLE_TERMINAL_TITLE) return

    if (route.data.type === "home") {
      renderer.setTerminalTitle("LOBSTER")
      return
    }
    ...
    if (route.data.type === "session") {
      ...
      renderer.setTerminalTitle(`LB | ${title}`)
    }
  })
  ...
  command.register(() => [
    ...
    },
    {
      ...
      value: "docs.open",
      onSelect: () => {
        open("https://github.com/HuskySteam/LOBSTER").catch(() => {})
        dialog.clear()
      },
      category: "System",
    },
    ...
    if (currentModel.providerID === "openrouter" && !kv.get("openrouter_warning", false)) {
      untrack(() => {
        DialogAlert.show(
          dialog,
          "Warning",
          "While openrouter is a convenient way to access LLMs your request will often be routed to subpar providers that do not work well in our testing.\n\nFor reliable access to models we recommend connecting a provider directly.",
  ...
  sdk.event.on(Installation.Event.UpdateAvailable.type, (evt) => {
    toast.show({
      ...
      message: `LOBSTER v${evt.properties.version} is available. Run 'lobster upgrade' to update manually.`,
      duration: 10000,
    })
  })
  ...
  return (
    <box
      ...
      onMouseUp={async () => {
        if (Flag.LOBSTER_EXPERIMENTAL_DISABLE_COPY_ON_SELECT) {
          renderer.clearSelection()
          return
        }
...
function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/HuskySteam/LOBSTER/issues/new?template=bug-report.yml")
