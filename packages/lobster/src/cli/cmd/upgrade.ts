...
export const UpgradeCommand = {
  ...
  describe: "upgrade lobster to the latest or a specific version",
  builder: (yargs: Argv) => {
    return yargs
      .positional("target", {
  ...
  handler: async (args: { target?: string; method?: string }) => {
    ...
    if (method === "unknown") {
      prompts.log.error(`lobster is installed to ${process.execPath} and may be managed by a package manager`)
