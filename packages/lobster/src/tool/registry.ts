...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@lobster-ai/plugin"
import z from "zod"
...
export namespace ToolRegistry {
  ...
  async function all(): Promise<Tool.Info[]> {
    ...
    return [
      InvalidTool,
      ...(["app", "cli", "desktop"].includes(Flag.LOBSTER_CLIENT) ? [QuestionTool] : []),
      BashTool,
      ReadTool,
      GlobTool,
      GrepTool,
      ...
      SkillTool,
      ApplyPatchTool,
      ...(Flag.LOBSTER_EXPERIMENTAL_LSP_TOOL ? [LspTool] : []),
      ...(config.experimental?.batch_tool === true ? [BatchTool] : []),
      ...(Flag.LOBSTER_EXPERIMENTAL_PLAN_MODE && Flag.LOBSTER_CLIENT === "cli" ? [PlanExitTool, PlanEnterTool] : []),
      ...(Flag.LOBSTER_EXPERIMENTAL_TEAMS
        ? [
            TeamCreateTool,
            TeamDeleteTool,
            TeamTaskCreateTool,
