      ...
      app
        ...
        .use(
          cors({
            origin(input) {
              ...
              const opencodeSuffix = ".opencode.ai"
              if (input.startsWith("https://")) {
                const host = input.slice(8) // Remove "https://"
                if (host === "opencode.ai" || (host.endsWith(opencodeSuffix) && /^[a-z0-9-]+(\.[a-z0-9-]+)*\.opencode\.ai$/.test(host))) {
                  return input
                }
              }
        ...
        .post(
          ...
          describeRoute({
            ...
            description: "Clean up and dispose the current Lobster instance, releasing all resources.",
        ...
        .get(
          ...
          describeRoute({
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the Lobster instance.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Get a list of all available commands in the Lobster system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List agents",
            description: "Get a list of all available AI agents in the Lobster system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List skills",
            description: "Get a list of all available skills in the Lobster system.",
