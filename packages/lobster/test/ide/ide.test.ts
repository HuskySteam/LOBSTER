...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders LOBSTER_CALLER", () => {
    process.env["LOBSTER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode LOBSTER_CALLER", () => {
    process.env["LOBSTER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown LOBSTER_CALLER", () => {
    process.env["LOBSTER_CALLER"] = "unknown"
